...
class mySteamTank1 {
  ...
  void display() {
    p1x = p1x + control1;
    image(C1, p1x, p1y, 0.18*height, 0.18*height);
  }
}
...
class myLoH1 {
  void display() {
    p1x = p1x + control1;
    image(C2, p1x, p1y, 0.18*height, 0.18*height);
  }
}
...
class myTotoro1 {
  void display() {
    p1x = p1x + control1;
    image(C3, p1x, p1y, 0.23*height, 0.23*height);
  }
}
...
class myLeo1 {
  void display() {
    p1x = p1x + control1;
    image(C4, p1x, p1y, 0.15*height, 0.15*height);
  }
}
...
class myHandgunners1 {
  void display() {
    p1x = p1x + 5*control1;
    image(C5, p1x, p1y, 0.3*height, 0.12*height);
  }
}
...
class myHowl1 {
  void display() {
    p1x = p1x + control1;
    image(C6, p1x, p1y, 0.25*height, 0.25*height);
  }
}
...
class mySteamTank2 {
  void display() {
    p2x = mouseX;
    image(C1, p2x, p2y, 0.18*height, 0.18*height);
  }
}
...
class myLoH2 {
  void display() {
    p2x = mouseX;
    image(C2, p2x, p2y, 0.18*height, 0.18*height);
  }
}
...
class myTotoro2 {
  void display() {
    p2x = mouseX;
    image(C3, p2x, p2y, 0.23*height, 0.23*height);
  }
}
...
class myLeo2 {
  void display() {
    p2x = mouseX;
    image(C4, p2x, p2y, 0.15*height, 0.15*height);
  }
}
...
class myHandgunners2 {
  void display() {
    p2x = mouseX;
    image(C5, p2x, p2y, 0.3*height, 0.12*height);
  }
}
...
class myHowl2 {
  void display() {
    p2x = mouseX;
    image(C6, p2x, p2y, 0.25*height, 0.25*height);
  }
}
...
void draw() {
  ...
  if (stage == 1) {
    ...
    fill(255, 255, 255);
    textFont(title);
    text("STEAM TANK WAR", (0.5)*width, (0.7)*height);
    fill(220+(35*(sin(frameCount))), 185, 220+(35*(sin(frameCount))));
    textFont(subtitle);
    if (frameCount >= 50) {
      text("Press any key to start the game", (0.5)*width, (0.7)*height + 50);
    }
  ...
  if (stage == 3) {
    ...
    text("Far on a distant land, there was an emperor greedy of natrual resources.", 0.5*width, 0.4*height);
    text("Endless exploitation of Earth and his ambition had offended a lot of people.", 0.5*width, 0.45*height);
    text("Thus, a war thereby begins.", 0.5*width, 0.5*height);
    text("Deprived of peace, even the most unlikely combatant joined the fray.", 0.5*width, 0.55*height);
  ...
  if (stage == 4) {
    ...
    image(selectscreen, 0, 0, width, height);
    textFont(loadings);
    text("Press 'w' 'a' 's' 'd' to select, press 'e' to choose for player 1, press 'k' to choose for player 2.", width*0.5, height-20);
    imageMode(CORNER);
    image(steamTankP, width/6, height/15, width/8, height/3);
    image(LoHP, width/2.4, height/15, width/8, height/3);
    image(totoroP, width/1.5, height/15, width/8, height/3);
    image(leoP, width/6, height/2.3, width/8, height/3);
    image(handgunnersP, width/2.4, height/2.3, width/8, height/3);
    image(howlP, width/1.5, height/2.3, width/8, height/3);
    if (key == 'd') {
      if (keyPressed == true) {
        button1.play();
        sx += 1;
    ...
    if (sx == 1 && sy == 1) {
      ...
      text("Empire's Steam Tank", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("'Tis the iron pride of the Empire of Man, soldiers' will, and Emperor Augustus' favorite form of transportation.", (0.5)*width, (0.9)*height);
    ...
    if (sx == 2 && sy == 1) {
      // LoHP
      textFont(explanationT);
      text("War Machine of the Crystal Sages", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("A war machine of the ancient developed by the scholars of the Grand Archive. Horridly destructive if exceptionally slow.", (0.5)*width, (0.9)*height);
    ...
    if (sx == 3 && sy == 1) {
      // totoro
      textFont(explanationT);
      text("Totoro", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("Not exactly sure what he can do, but he seems like a good neighbor.", (0.5)*width, (0.9)*height);
      tint(0, 153+(sin(frameCount)*30), 204);
      image(totoroP, width/1.5, height/15, width/8, height/3);
      if (keyPressed == true && key == 'e') {
        Atc1 = At3;
    ...
    if (sx == 1 && sy == 2) {
      // Da Vinci
      textFont(explanationT);
      text("Leonardo's Combat Car", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("Da Vinci's talents are conspicuously showed in his wondrous inventions, such as this wooden Croque-Madame.", (0.5)*width, (0.9)*height);
      tint(0, 153+(sin(frameCount)*30), 204);
      image(leoP, width/6, height/2.3, width/8, height/3);
      if (keyPressed == true && key == 'e') {
        Atc1 = At4;
    ...
    if (sx == 2 && sy == 2) {
      // Handgunner
      textFont(explanationT);
      text("Handgunners", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("Unus pro omnibus, omnes pro uno. A solitary handgunner is no threat to even the most ragamuffin plebs, provided his cohorts are not present.", (0.5)*width, (0.9)*height);
      tint(0, 153+(sin(frameCount)*30), 204);
      image(handgunnersP, width/2.4, height/2.3, width/8, height/3);
      if (keyPressed == true && key == 'e') {
        Atc1 = At5;
    ...
    if (sx == 3 && sy == 2) {
      // Howl
      textFont(explanationT);
      text("Howl's Moving Castle", (0.5)*width, (0.85)*height);
      textFont(explanations);
      text("Let love and kindness be! When duty calls, this piece of junk also joins the brawl, and it will keep fighting until peace is found.", (0.5)*width, (0.9)*height);
      tint(0, 153+(sin(frameCount)*30), 204);
      image(howlP, width/1.5, height/2.3, width/8, height/3);
      if (keyPressed == true && key == 'e') {
        Atc1 = At6;
    ...
    if (character1 == 1) {
      ...
      HP1c = HP1;
      text("Player1 is Empire's Steam Tank!", 0.5*width, 0.05*height);
    }
    if (character1 == 2) {
      HP1c = HP2;
      text("Player1 is War Machine of the Crystal Sages!", 0.5*width, 0.05*height);
    }
    if (character1 == 3) {
      HP1c = HP3;
      text("Player1 is Totoro!", 0.5*width, 0.05*height);
    }
    if (character1 == 4) {
      HP1c = HP4;
      text("Player1 is Leonardo's Combat Car!", 0.5*width, 0.05*height);
    }
    if (character1 == 5) {
      HP1c = HP5;
      text("Player1 is Handgunners!", 0.5*width, 0.05*height);
    }
    if (character1 == 6) {
      HP1c = HP6;
      text("Player1 is Howl's Moving Castle!", 0.5*width, 0.05*height);
    }

    //player2
    if (character2 == 1) {
      HP2c = HP1;
      text("Player2 is Empire's Steam Tank!", 0.5*width, 0.05*height);
    }
    if (character2 == 2) {
      HP2c = HP2;
      text("Player2 is War Machine of the Crystal Sages!", 0.5*width, 0.05*height);
    }
    if (character2 == 3) {
      HP2c = HP3;
      text("Player2 is Totoro!", 0.5*width, 0.05*height);
    }
    if (character2 == 4) {
      HP2c = HP4;
      text("Player2 is Leonardo's Combat Car!", 0.5*width, 0.05*height);
    }
    if (character2 == 5) {
      HP2c = HP5;
      text("Player2 is Handgunners!", 0.5*width, 0.05*height);
    }
    if (character2 == 6) {
      HP2c = HP6;
      text("Player2 is Howl's Moving Castle!", 0.5*width, 0.05*height);
    }
  ...
  if (stage == 5) {
    ...
    if (keyPressed == true && key =='q' && b1y <= 0.05*height) {
      // press q to shoot
      hit1.play();
      b1x = p1x;
      b1y = p1y;
    }
    if (mousePressed == true && b2y >= 0.95*height) {
    ...
    if (character1 == 1) {
      ...
      if ((b2y >= (0.85*height)) && (b2y <= height) && (b2x - p1x <= (0.18*height)) && (b2x - p1x >= 0)) {
        // judgement of how much damage suffered
        HP1c = HP1c - Atc2;
        image(hurt, p1x, p1y, 0.08*height, 0.08*height);
        punch.play();
      }
    }
    if (character1 == 2) {
    ...
    if (character1 == 3) {
      ...
      if ((b2y >= (0.85*height)) && (b2y <= height) && (b2x - p1x <= (0.23*height)) && (b2x - p1x >= 0)) {
        HP1c = HP1c - Atc2;
        image(hurt, p1x, p1y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character1 == 4) {
      ...
      if ((b2y >= (0.85*height)) && (b2y <= height) && (b2x - p1x <= (0.15*height)) && (b2x - p1x >= 0)) {
        HP1c = HP1c - Atc2;
        image(hurt, p1x, p1y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character1 == 5) {
      ...
      if ((b2y >= (0.85*height)) && (b2y <= height) && (b2x - p1x <= (0.3*height)) && (b2x - p1x >= 0)) {
        HP1c = HP1c - Atc2;
        image(hurt, p1x, p1y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character1 == 6) {
      ...
      if ((b2y >= (0.85*height)) && (b2y <= height) && (b2x - p1x <= (0.25*height)) && (b2x - p1x >= 0)) {
        HP1c = HP1c - Atc2;
        image(hurt, p1x, p1y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character2 == 1) {
      ...
      if ((b1y <= (0.15*height)) && (b1y >= 0) && (b1x - p2x <= (0.18*height)) && (b1x - p2x >= 0) ) {
        HP2c = HP2c - Atc1;
        image(hurt, p2x, p2y, 0.08*height, 0.08*height);
        punch.play();
      }
    }
    if (character2 == 2) {
    ...
    if (character2 == 3) {
      ...
      if ((b1y <= (0.15*height)) && (b1y >= 0) && (b1x - p2x <= (0.23*height)) && (b1x - p2x >= 0) ) {
        HP2c = HP2c - Atc1;
        image(hurt, p2x, p2y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character2 == 4) {
      ...
      if ((b1y <= (0.15*height)) && (b1y >= 0) && (b1x - p2x <= (0.15*height)) && (b1x - p2x >= 0) ) {
        HP2c = HP2c - Atc1;
        image(hurt, p2x, p2y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character2 == 5) {
      ...
      if ((b1y <= (0.15*height)) && (b1y >= 0) && (b1x - p2x <= (0.3*height)) && (b1x - p2x >= 0) ) {
        HP2c = HP2c - Atc1;
        image(hurt, p2x, p2y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    if (character2 == 6) {
      ...
      if ((b1y <= (0.15*height)) && (b1y >= 0) && (b1x - p2x <= (0.25*height)) && (b1x - p2x >= 0) ) {
        HP2c = HP2c - Atc1;
        image(hurt, p2x, p2y, 0.08*height, 0.08*height);
        punch.play();
      }
    ...
    text(HP1c, 0.1*width, 0.4*height);
    text(HP2c, 0.9*width, 0.4*height);

    if (HP2c <= 0) {
      image(Boom, p2x, p2y, 0.15*height, 0.15*height);
      boom.play();
      mtimer = millis();
      stage = 6;
    }
    if (HP1c <= 0) {
      image(Boom, p1x, p1y, 0.15*height, 0.15*height);
      boom.play();
      mtimer = millis();
      stage = 7;
    }
  ...
  if (stage == 6) {
    ...
    if (millis() - mtimer >= 500) {
      background(0, 0, 0);
      textFont(loading);
      text("Player 1 wins!", 0.5*width, 0.5*height);
    }
    if (millis() - mtimer >= 1000) {
      textFont(explanations);
      text("Restarting the game...", 0.5*width, 0.95*height);
    }
  ...
  if (stage == 7) {
    ...
    if (millis() - mtimer >= 500) {
      background(0, 0, 0);
      textFont(loading);
      text("Player 2 wins!", 0.5*width, 0.5*height);
    }
